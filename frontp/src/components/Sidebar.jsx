...
const Sidebar = ({ user, onLogout }) => {
  ...
  const paginas = [
    ...
    { 
      ...
      submenu: [
        ...
        { path: '/almacen/consulta-stock', name: 'Consulta Stock', ruta: 'almacen_consulta_stock' },
        { path: '/almacen/notas', name: 'Notas de Almacén', ruta: 'almacen_notas' },
        { path: '/almacen/movimientos', name: 'Movimientos', ruta: 'almacen_movimientos' },
        { path: '/almacen/kardex', name: 'Kardex', ruta: 'almacen_kardex' },
        { path: '/almacen/reportes', name: 'Reportes', ruta: 'almacen_reportes' },
      ]
    },
    ...
    { 
      ...
      submenu: [
        ...
        { path: "/venta/ordenes-fabricacion", name: "Órdenes de Fabricación", ruta: "venta_ordenes_fabricacion" },
        { path: "/venta/guias", name: "Guias", ruta: "venta_guias" },
      ]
    },
  ...
  submenu: [
    ...
    { path: '/mantenimiento/ordenes-trabajo', name: 'Órdenes de Trabajo', ruta: 'mantenimiento_ordenes_trabajo' },
