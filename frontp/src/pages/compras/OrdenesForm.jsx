...
const getRequerimientosFiltrados = () => {
  ...
  const buscarProductosRequerimiento = async (requerimientoId) => {
    try {
      const response = await api.get(`/compras/requerimientos/${requerimientoId}/detalles`);
      setProductos(response.data.detalles || []);
    } catch (error) {
    ...
    >
      <Row gutter={16}>
        ...
        <Col span={8}>
          ...
          >
            <Select placeholder="Seleccionar documento">
              ...
              <Row align="middle" gutter={8}>
                ...
                <Col>
                  <Button
                    ...
                    disabled={items.some(item => item.producto_codigo === producto.producto_codigo)}
                  >
                    Agregar
                  </Button>
                </Col>
