...
const validarUpdateOrdenCompra = require('../middlewares/validarUpdateOrdenCompra');
...
router.put('/ordenes-compra/:id', auth.verifyToken, validarUpdateOrdenCompra, comprasController.updateOrdenCompra);
